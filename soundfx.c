...
void soundfx_play(soundfx_t *sfx, int tune) {
    ...
    if (sfx->tune_idx == TUNE_NEXTLEVEL){
        return;
    }
    sfx->tune_idx = tune;
    sfx->tune_offset = 0;
...
soundfx_t* soundfx_create() {
    ...
    sfx->tunes[0].sz = invfreq_decode_soundfx(silence, sfx->tunes[0].raw, 4096 * 512);
    ...
    sfx->tunes[2].sz = invfreq_decode_soundfx(treasure, sfx->tunes[2].raw, 4096 * 512);

    strcpy(sfx->tunes[3].name, "nextlevel");
    sfx->tunes[3].raw = malloc(4096 * 512);
    sfx->tunes[3].sz = invfreq_decode_soundfx(nextlevel, sfx->tunes[3].raw, 4096 * 512);

    strcpy(sfx->tunes[4].name, "walking");
    sfx->tunes[4].raw = malloc(4096 * 512);
    sfx->tunes[4].sz = invfreq_decode_soundfx(walking, sfx->tunes[4].raw, 4096 * 512);

    strcpy(sfx->tunes[5].name, "jumping");
    sfx->tunes[5].raw = malloc(4096 * 512);
    sfx->tunes[5].sz = invfreq_decode_soundfx(jumping, sfx->tunes[5].raw, 4096 * 512);
